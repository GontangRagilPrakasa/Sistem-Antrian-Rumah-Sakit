          ...
          <!--    <table class="table table-striped table-hover ">
              <thead>
               ...
               <?php 
                  ...
                  $query=mysql_query("SELECT * FROM tallera ORDER BY id DESC") or die (mysql_error());
                  ...
                  <button  class="btn btn-success" type="button" value='Teller 1' id='Panggil1' name='Panggil1' >Tambah Antrian</button> 
                   <a href="hapus.php"><button  class="btn btn-success" >Reset</button></a> 
