          ...
          <div class="">
            ...
            <!--  <table class="table table-striped table-hover ">
             ...
             <?php 
                  ...
                  $query=mysql_query("SELECT * FROM tallerc ORDER BY idc DESC") or die (mysql_error());
                  ...
                  <button  class="btn btn-success" type="button" value='Teller 3' id='Panggil3' name='Panggil3' >Tambah Antrian</button> 
                   <a href="hapusc.php"><button  class="btn btn-success" >Reset</button></a> 
